...
def run_vrp():
    ...
    route = VRPtime_windows_algorithm(locations, vehicles, avg_speed, time_windows, depot_location)
...
def VRPtime_windows_algorithm(locations, vehicles, avg_speed, time_windows, depot_location):
...
if __name__ == '__main__':
    run_simple('127.0.0.1', 21100, app, use_reloader=True)